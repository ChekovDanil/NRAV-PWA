"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[6652],{18520:(e,t,i)=>{i.d(t,{f:()=>c});var r=i(7620);let o=`#version 300 es
...
}`;function l(e){if(e.naturalWidth<1024&&e.naturalHeight<1024){if(e.naturalWidth<1||e.naturalHeight<1)return;let t=e.naturalWidth/e.naturalHeight;e.width=Math.round(t>1?1024*t:1024),e.height=Math.round(t>1?1024:1024/t)}}var h=i(54568);async function g(e){let t={},i=[];return Object.entries(e).forEach(([e,r])=>{if("string"==typeof r){let o=r||"data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";if(!(e=>{try{if(e.startsWith("/"))return!0;return new URL(e),!0}catch{return!1}})(o))return void console.warn(`Uniform "${e}" has invalid URL "${o}". Skipping image loading.`);let s=new Promise((i,r)=>{let s=new Image;(e=>{try{if(e.startsWith("/"))return!1;return new URL(e,window.location.origin).origin!==window.location.origin}catch{return!1}})(o)&&(s.crossOrigin="anonymous"),s.onload=()=>{l(s),t[e]=s,i()},s.onerror=()=>{console.error(`Could not set uniforms. Failed to load image at ${o}`),r()},s.src=o});i.push(s)}else r instanceof HTMLImageElement&&l(r),t[e]=r}),await Promise.all(i),t}let c=(0,r.forwardRef)(function({fragmentShader:e,uniforms:t,webGlContextAttributes:i,speed:o=0,frame:s=0,width:n,height:A,minPixelRatio:l,maxPixelCount:c,mipmaps:u,style:B,...m},p){var f;let d,E,[w,x]=(0,r.useState)(!1),Q=(0,r.useRef)(null),v=(0,r.useRef)(null),S=(0,r.useRef)(i);(0,r.useEffect)(()=>((async()=>{let i=await g(t);Q.current&&!v.current&&(v.current=new a(Q.current,e,i,S.current,o,s,l,c,u),x(!0))})(),()=>{v.current?.dispose(),v.current=null}),[e]),(0,r.useEffect)(()=>{let e=!1;return(async()=>{let i=await g(t);e||v.current?.setUniforms(i)})(),()=>{e=!0}},[t,w]),(0,r.useEffect)(()=>{v.current?.setSpeed(o)},[o,w]),(0,r.useEffect)(()=>{v.current?.setMaxPixelCount(c)},[c,w]),(0,r.useEffect)(()=>{v.current?.setMinPixelRatio(l)},[l,w]),(0,r.useEffect)(()=>{v.current?.setFrame(s)},[s,w]);let C=(f=[Q,p],d=r.useRef(void 0),E=r.useCallback(e=>{let t=f.map(t=>{if(null!=t){if("function"==typeof t){let i=t(e);return"function"==typeof i?i:()=>{t(null)}}return t.current=e,()=>{t.current=null}}});return()=>{t.forEach(e=>e?.())}},f),r.useMemo(()=>f.every(e=>null==e)?null:e=>{d.current&&(d.current(),d.current=void 0),null!=e&&(d.current=E(e))},f));return(0,h.jsx)("div",{ref:C,style:void 0!==n||void 0!==A?{width:"string"==typeof n&&!1===isNaN(+n)?+n:n,height:"string"==typeof A&&!1===isNaN(+A)?+A:A,...B}:B,...m})});c.displayName="ShaderMount"},19368:(e,t,i)=>{i.d(t,{Bl:()=>u});var r=i(7620),o=i(18520),s=i(95989),a=i(81900),n=i(93489),A=i(88087);let l=`#version 300 es
precision mediump float;
...
`},90136:(e,t,i)=>{i.d(t,{A:()=>r});let r=(0,i(81007).A)("Camera",[["path",{d:"M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z",key:"1tc9qg"}],["circle",{cx:"12",cy:"13",r:"3",key:"1vg3eu"}]])},93489:(e,t,i)=>{function r(e){if(Array.isArray(e))return 4===e.length?e:3===e.length?[...e,1]:s;if("string"!=typeof e)return s;let t,i,r,a=1;if(e.startsWith("#")){var n;[t,i,r,a]=(3===(n=(n=e).replace(/^#/,"")).length&&(n=n.split("").map(e=>e+e).join("")),6===n.length&&(n+="ff"),[parseInt(n.slice(0,2),16)/255,parseInt(n.slice(2,4),16)/255,parseInt(n.slice(4,6),16)/255,parseInt(n.slice(6,8),16)/255])}else if(e.startsWith("rgb")){let o;[t,i,r,a]=(o=e.match(/^rgba?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([0-9.]+))?\s*\)$/i))?[parseInt(o[1]??"0")/255,parseInt(o[2]??"0")/255,parseInt(o[3]??"0")/255,void 0===o[4]?1:parseFloat(o[4])]:[0,0,0,1]}else{let o;if(!e.startsWith("hsl"))return console.error("Unsupported color format",e),s;[t,i,r,a]=function(e){let t,i,r,[o,s,a,n]=e,A=o/360,l=s/100,h=a/100;if(0===s)t=i=r=h;else{let e=(e,t,i)=>(i<0&&(i+=1),i>1&&(i-=1),i<1/6)?e+(t-e)*6*i:i<.5?t:i<2/3?e+(t-e)*(2/3-i)*6:e,o=h<.5?h*(1+l):h+l-h*l,s=2*h-o;t=e(s,o,A+1/3),i=e(s,o,A),r=e(s,o,A-1/3)}return[t,i,r,n]}((o=e.match(/^hsla?\s*\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(?:,\s*([0-9.]+))?\s*\)$/i))?[parseInt(o[1]??"0"),parseInt(o[2]??"0"),parseInt(o[3]??"0"),void 0===o[4]?1:parseFloat(o[4])]:[0,0,0,1])}return[o(t,0,1),o(i,0,1),o(r,0,1),o(a,0,1)]}i.d(t,{G:()=>r});let o=(e,t,i)=>Math.min(Math.max(e,t),i),s=[0,0,0,1]},93984:(e,t,i)=>{i.d(t,{A:()=>r});let r=(0,i(81007).A)("LockKeyhole",[["circle",{cx:"12",cy:"16",r:"1",key:"1au0dj"}],["rect",{x:"3",y:"10",width:"18",height:"12",rx:"2",key:"6s8ecr"}],["path",{d:"M7 10V7a5 5 0 0 1 10 0v3",key:"1pqi11"}]])},95989:(e,t,i)=>{i.d(t,{q:()=>r});function r(e,t){for(let i in e){if("colors"===i){let i=Array.isArray(e.colors),r=Array.isArray(t.colors);if(!i||!r){if(!1===Object.is(e.colors,t.colors))return!1;continue}if(e.colors?.length!==t.colors?.length||!e.colors?.every((e,i)=>e===t.colors?.[i]))return!1;continue}if(!1===Object.is(e[i],t[i]))return!1}return!0}}}]);