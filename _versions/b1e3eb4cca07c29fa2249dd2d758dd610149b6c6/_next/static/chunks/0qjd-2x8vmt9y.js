(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,37881,573,31967,21449,e=>{"use strict";var t=e.i(71645);let i=`#version 300 es
...
`;e.s(["colorBandingFix",0,o,"declarePI",0,t,"proceduralHash21",0,r,"rotation2",0,i])},65614,e=>{"use strict";var t=e.i(71645),i=e.i(37881),r=e.i(573),o=e.i(31967),s=e.i(21449),a=e.i(45426),n=e.i(93344);let A=`#version 300 es
precision mediump float;
...
`,l={checks:0,stripes:1,edge:2};var h=e.i(43476);let g={name:"Default",params:{...o.defaultPatternSizing,rotation:0,speed:1,frame:0,colors:["#121212","#9470ff","#121212","#8838ff"],proportion:.45,softness:1,distortion:.25,swirl:.8,swirlIterations:10,shapeScale:.1,shape:"checks"}};o.defaultPatternSizing,o.defaultPatternSizing,o.defaultPatternSizing,o.defaultPatternSizing,o.defaultPatternSizing;let c=(0,t.memo)(function({speed:e=g.params.speed,frame:t=g.params.frame,colors:r=g.params.colors,proportion:n=g.params.proportion,softness:c=g.params.softness,distortion:u=g.params.distortion,swirl:m=g.params.swirl,swirlIterations:d=g.params.swirlIterations,shapeScale:B=g.params.shapeScale,shape:p=g.params.shape,fit:f=g.params.fit,scale:E=g.params.scale,rotation:w=g.params.rotation,originX:x=g.params.originX,originY:Q=g.params.originY,offsetX:v=g.params.offsetX,offsetY:S=g.params.offsetY,worldWidth:C=g.params.worldWidth,worldHeight:I=g.params.worldHeight,...U}){let R={u_colors:r.map(s.getShaderColorFromString),u_colorsCount:r.length,u_proportion:n,u_softness:c,u_distortion:u,u_swirl:m,u_swirlIterations:d,u_shapeScale:B,u_shape:l[p],u_noiseTexture:(0,a.getShaderNoiseTexture)(),u_scale:E,u_rotation:w,u_fit:o.ShaderFitOptions[f],u_offsetX:v,u_offsetY:S,u_originX:x,u_originY:Q,u_worldWidth:C,u_worldHeight:I};return(0,h.jsx)(i.ShaderMount,{...U,speed:e,frame:t,fragmentShader:A,uniforms:R})},r.colorPropsAreEqual);e.s(["Warp",0,c],65614)},35677,e=>{"use strict";e.s(["readReducedMotionPreference",0,function(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches},"subscribeReducedMotionPreference",0,function(e){let t=window.matchMedia("(prefers-reduced-motion: reduce)");return t.addEventListener("change",e),()=>t.removeEventListener("change",e)}])}]);